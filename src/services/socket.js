...
//192.168.205.140
export const socket = io('http://seashepherd.duckdns.org:3170', {transports: ['websocket', 'polling'], withCredentials: true});
// export const socket = io('http://172.20.10.4:3169');
