        ...
        <v-main>
            ...
            <v-container fluid>
                ...
                <v-card class="mx-auto slidecontainer" height="800" width="800">
                    <v-text-field v-model="nombreLugarBusqueda"
                        label="Introduce el nombre del área que quieras buscar"></v-text-field>
                    ...
                    <v-card v-if="areaEncontrada" class="mt-4">
                        <v-text-field v-model="nuevoNombreLugar" label="Nuevo nombre del área"></v-text-field>
                        <v-btn @click="editarNombre" :disabled="nuevoNombreLugar === ''">
                            Editar
                        </v-btn>
                        <v-btn @click="eliminarArea">
                            Eliminar
                        </v-btn>
